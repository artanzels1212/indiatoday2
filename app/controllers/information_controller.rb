class InformationController < ApplicationController
  ...
  private
    ...
    def information_params
      params.require(:information).permit(:create_By, :sync_date, :sync_status, :google_status, :delivery_no, :delivery_status, :update_by_idil, :update_date_idil, :update_by_customer, :update_date_customer, :qc_date, :qc_by, :qc_status, :qc_remarks, :user_id)
    end
end
